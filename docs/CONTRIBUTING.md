...
We welcome any kind of contribution to `zampy`, from simple comment or question to a full fledged pull request. Please read and follow our [Code of Conduct](CODE_OF_CONDUCT.md).
...
1. use the search functionality [here](https://github.com/EcoExtreML/zampy/issues) to see if someone already filed the same issue;
...
If you want to make some kind of change to the code base, for instance, adding more datasets to the collection and supporting more conventions, please follow the steps below:
...
1. push your feature branch to (your fork of) the `zampy` repository on GitHub;
